...
int wWinMain (_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR szCmdLine, _In_ int iCmdShow)
{
     ...
     hwndModeless = CreateDialog (hInstance, szAppName, hwnd, (DLGPROC)MainDlg) ;
...
BOOL CALLBACK MainDlg (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
     ...
     case WM_COMMAND:
          ...
          {
          case IDC_SERVER:
               DialogBoxParam (hInst, TEXT ("Servers"), hwnd, (DLGPROC)ServerDlg, 
                               (LPARAM) szIPAddr) ;
               return TRUE ;
...
BOOL CALLBACK ServerDlg (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
     ...
     case WM_COMMAND:
          ...
          case IDOK:
               ...
               strtok_s (szLabel, "(", &ptr) ;
               strcpy_s (szServer, 64, strtok_s (NULL, ")", &ptr)) ;
               EndDialog (hwnd, TRUE) ;
               return TRUE ;
