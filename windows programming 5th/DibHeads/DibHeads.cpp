...
int wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ PWSTR szCmdLine, _In_ int iCmdShow)
{
    ...
    wndclass.lpszMenuName = MAKEINTRESOURCE(DIBHEADS);
    ...
    hAccel = LoadAccelerators(hInstance, MAKEINTRESOURCE(DIBHEADS));
...
{
    static const TCHAR* szInfoName[] = { TEXT("BITMAPCOREHEADER"),
                                         TEXT("BITMAPINFOHEADER"),
                                         TEXT("BITMAPV4HEADER"),
                                         TEXT("BITMAPV5HEADER") };
    static const TCHAR* szCompression[] = { TEXT("BI_RGB"), TEXT("BI_RLE8"),
                                            TEXT("BI_RLE4"),
                                            TEXT("BI_BITFIELDS"),
                                            TEXT("unknown") };
