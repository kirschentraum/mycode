...
LRESULT CALLBACK WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        hMenuMain = LoadMenuW(hInstance, MAKEINTRESOURCE(MENUMAIN));
        hMenuFile = LoadMenuW(hInstance, MAKEINTRESOURCE(MENUFILE));
        hMenuEdit = LoadMenuW(hInstance, MAKEINTRESOURCE(MENUEDIT));
