...
LRESULT WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
        ...
        for (i = 0; i < min(cLines, cyClient / cyChar - 1); i++)
        {
            ...
            GetKeyNameText(LONG(pmsg[i].lParam), szKeyName,
...
int WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ PSTR szCmdLine, _In_ int iCmdShow)
{
