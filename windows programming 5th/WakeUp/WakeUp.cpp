    ...
    case WM_CREATE:
        ...
        *pwaveform = waveform;
        ...
        SubbedProc[ID_TIMEPICK] = (WNDPROC)
            SetWindowLongPtr(hwndDTP, GWLP_WNDPROC, (LONG_PTR)SubProc);
        SubbedProc[ID_CHECKBOX] = (WNDPROC)
            SetWindowLongPtr(hwndCheck, GWLP_WNDPROC, (LONG_PTR)SubProc);
        SubbedProc[ID_PUSHBTN] = (WNDPROC)
            SetWindowLongPtr(hwndPush, GWLP_WNDPROC, (LONG_PTR)SubProc);
...
{
    long long idNext, id = GetWindowLongPtr(hwnd, GWLP_ID);
