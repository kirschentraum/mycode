...
VOID             ButtonSwitch (HWND, HWND, const TCHAR *) ;
...
VOID ButtonSwitch (HWND hwndStatus, HWND hwndButton, const TCHAR * szText) 
{
     if (szText)
...
FILELIST * GetFileList (void)
{
     ...
     qsort (plist->info, iNum, sizeof (FILEINFO), (_CoreCrtNonSecureSearchSortCompareFunction)Compare) ;
