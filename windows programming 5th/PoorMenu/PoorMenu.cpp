...

{
    ...
    AppendMenuW(hMenu, MF_STRING, IDM_SYS_ABOUT, TEXT("About..."));
    AppendMenuW(hMenu, MF_STRING, IDM_SYS_HELP, TEXT("Help..."));
    AppendMenuW(hMenu, MF_STRING, IDM_SYS_REMOVE, TEXT("Remove Additions"));
