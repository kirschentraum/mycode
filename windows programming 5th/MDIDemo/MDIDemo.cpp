#include <windows.h>
#include "resource.h"
constexpr auto INIT_MENU_POS = 0;
constexpr auto HELLO_MENU_POS = 2;
constexpr auto RECT_MENU_POS = 1;
constexpr auto IDM_FIRSTCHILD = 50000;
                               ...
                               WPARAM wParam, LPARAM lParam)
{
     ...
     case WM_CREATE:
          ...
          SetWindowLongPtr (hwnd, 0, (__int64) pHelloData) ;
                              ...
                              WPARAM wParam, LPARAM lParam)
{
     ...
     case WM_CREATE:
          ...
          SetWindowLongPtr (hwnd, 0, (_int64) pRectData) ;
