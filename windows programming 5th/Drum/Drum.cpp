...
void  ErrorMessage  (HWND, const TCHAR *, const TCHAR *) ;
void  DoCaption     (HWND, TCHAR *) ;
int   AskAboutSave  (HWND, TCHAR *) ;

const TCHAR * szPerc [NUM_PERC] =
{
...
const TCHAR   szAppName  [] = TEXT ("Drum") ;
const TCHAR   szUntitled [] = TEXT ("(Untitled)") ;
...
LRESULT CALLBACK WndProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
     ...
     case WM_COMMAND:
          ...
          case IDM_APP_ABOUT:
               DialogBox ((HINSTANCE)hInst, TEXT ("AboutBox"), hwnd, (DLGPROC)AboutProc) ;
               return 0 ;
          }
          return 0 ;
...
void ErrorMessage (HWND hwnd, const TCHAR * szError, const TCHAR * szTitleName)
{
