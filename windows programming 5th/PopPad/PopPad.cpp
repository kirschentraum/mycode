...
constexpr auto EDITID = 1;
constexpr auto UNTITLED = L"(untitled)";
     ...
     case WM_COMMAND:
          ...
          case IDM_FILE_OPEN:
               ...
               if (PopFileOpenDlg (hwnd, szFileName, szTitleName))
               {
                    ...
                    {
                         OkMessage (hwnd, (TCHAR*)L"Could not read file %s!", (TCHAR*)szTitleName) ;
                         szFileName[0]  = '\0' ;
                         szTitleName[0] = '\0' ;
                    }
               }
          ...
          case IDM_FILE_SAVE:
               if (szFileName[0])
               {
                    ...
                    {
                         OkMessage (hwnd, (TCHAR*)L"Could not write file %s",
                             (TCHAR*)szTitleName) ;
                         return 0 ;
                    }
               }
          ...
          case IDM_FILE_PRINT:
               if (!PopPrntPrintFile (hInst, hwnd, hwndEdit, szTitleName))
                    OkMessage (hwnd, (TCHAR*)L"Could not print file %s", (TCHAR*)szTitleName) ;
               return 0 ;
          ...
          case IDM_HELP:
               OkMessage (hwnd, (TCHAR*)L"Help not yet implemented!", (TCHAR*)L"\0") ;
               return 0 ;
               
          case IDM_APP_ABOUT:
               DialogBox (hInst, MAKEINTRESOURCE(ABOUTBOX), hwnd, (DLGPROC)AboutDlgProc) ;
               return 0 ;
          }
          break ;
          ...
          if (message == messageFindReplace)
          {
               ...
               if (pfr->Flags & FR_FINDNEXT)
                    if (!PopFindFindText (hwndEdit, &iOffset, pfr))
                         OkMessage (hwnd, (TCHAR*)L"Text not found!", (TCHAR*)L"\0") ;
